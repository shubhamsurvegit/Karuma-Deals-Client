...
const brands=['Hyundai', 'Mahindra', 'Maruti', 'Ford', 'Skoda', 'Audi', 'Toyota',
'Renault', 'Honda', 'Datsun', 'Mitsubishi', 'Tata', 'Volkswagen',
'I', 'Chevrolet', 'Mini', 'BMW', 'Nissan', 'Hindustan', 'Fiat',
'Force', 'Mercedes', 'Land', 'Jaguar', 'Jeep', 'Volvo']

const models=['Hyundai Santro Xing XO eRLX Euro III', 'Mahindra Jeep CL550 MDI',
...
module.exports={fuel_types,brands,models}